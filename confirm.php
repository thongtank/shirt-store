    ...
    <form action="#" method="POST" class="form-horizontal form-register">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="radio" id="bank_to" name="bank_to" value="1" required> ธนาคาร 1 <br/>
                    <span class="greenColor">ชื่อบัญชี xxxxxxxx xxxxxxxx เลขที่บัญชี xxx-x-xxxxx-x</span><br/>
                    <input type="radio" id="bank_to" name="bank_to" value="2" required> ธนาคาร 2 <br/>
                    <span class="greenColor">ชื่อบัญชี xxxxxxxx xxxxxxxx เลขที่บัญชี xxx-x-xxxxx-x</span><br/>
                    <input type="radio" id="bank_to" name="bank_to" value="3" required> ธนาคาร 3 <br/>
                    <span class="greenColor">ชื่อบัญชี xxxxxxxx xxxxxxxx เลขที่บัญชี xxx-x-xxxxx-x</span><br/>
